...
public static class Config
{
    public static void ExecWarmup(int warmupTime = -1, bool isLockTeams = false) =>
        Swiftly.Core.Engine.ExecuteCommand([
            ...
            "tv_enable_dynamic 1",
            // Team lock convars
            $"mp_force_pick_time {(isLockTeams ? 0 : 15)}",
            $"sv_disable_teamselect_menu {(isLockTeams ? 1 : 0)}",
            // Backup convars
    ...
    public static void ExecLive(
        ...
        Swiftly.Core.Engine.ExecuteCommand([
            ...
            $"mp_overtime_maxrounds {otMaxRounds}",
            ...
            "mp_warmuptime_all_players_connected 0",
            // Pause settings
            $"sv_vote_issue_timeout_allowed {(isFriendlyPause ? 0 : 1)}",
